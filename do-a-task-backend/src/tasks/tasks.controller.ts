...
export class TasksController {
  ...
  async GetTasksMemberDoing(@Req() req: RequestWithUser, @Res() res: Response) {
    ...
    return res.json({
      ...
      community: tasks.community,
    });
  }

  @Get('getTasksMemberCreated')
  @UseGuards(JwtAuthGuard)
  async GetTasksMemberCreated(
  ...
  @Get('getTasksMemberDone')
  @UseGuards(JwtAuthGuard)
  async getTasksMemberDone(@Req() req: RequestWithUser, @Res() res: Response) {
    const tasks = await this.tasksService.getTasksMemberDone(req.user.sub);
    return res.json({ message: 'Completed tasks found', tasks });
  }
  ...
  @UseGuards(JwtAuthGuard)
  async finishTask(
    @Query('memberTaskId', ParseIntPipe) memberTaskId: number,
    @Req() req: RequestWithUser,
    @Res() res: Response,
  ) {
