    ...
    <div className="page">
      ...
      <main>
        <section className={styles.containercenter}>
          <p>
            Transforme boas ações em benefícios com o DoaTask! Siga este guia
            simples para começar a ajudar a sua comunidade e ganhar recompensas.
          </p>
        </section>
        ...
        <section className={styles.containercenter}>
          <div>
            ...
            <p>
              Basta inserir o seu e-mail, criar uma palavra-passe e preencher os
              dados básicos do seu perfil.
            </p>
            <p>
              Em poucos minutos, estará pronto para começar a usar a plataforma.
            </p>
          </div>
        ...
        <section className={styles.containercenter}>
          <div className={styles.buttons}>
            <a className={styles.buttonleft} href={ROUTES.SIGNUP}>
              Cria uma conta
            </a>
            <a className={styles.buttonright} href={ROUTES.SIGNIN}>
              Iniciar sessão
            </a>
          </div>
        </section>
        ...
        <section className={styles.containercenter}>
          <div className={styles.buttons}>
            <a className={styles.taskbutton} href={ROUTES.USER_MAIN}>
              Perfil
            </a>
          </div>
        </section>
        ...
        <section className={styles.containercenter}>
          <div className={styles.buttons}>
            <a className={styles.buttonleft} href={ROUTES.CREATE_COMMUNITY}>
              Criar Comunidade
            </a>
            <a className={styles.buttonright} href={ROUTES.ENTER_COMMUNITY}>
              Entrar Comunidade
            </a>
          </div>
        </section>
